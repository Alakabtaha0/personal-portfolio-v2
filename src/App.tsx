	...
	return (
		<div className='display-layout'>
			<header className='main-section'>
				<div className='header-display add-margin'>
					<h1>Taha Al-Asadi</h1>
				...
				<nav className='navbar'>
					<ul>
						<li><div className='section-line'></div><a href='#About'>About</a></li>
						<li><div className='section-line'></div><a href='#Experience'>Experience</a></li>
						<li><div className='section-line'></div><a href='#Projects'>Projects</a></li>
					</ul>
				</nav>
				<div className='logo-layout add-margin'>
